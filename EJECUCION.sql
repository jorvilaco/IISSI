...
BEGIN
  ...
  **********************************************************************/
  ...
  PRUEBAS_CONCESIONARIO.ACTUALIZAR('Con-9/Update-"Concesionario= prueba"                    /Commit-->',2,'ConCon','calle',756493498,'prueba@prueba.com',0,true);
...
/*********************************************************************
  ...
  **********************************************************************/
  ...
  PRUEBAS_CITAS.INSERTAR('Cit-01/insert-"Cita = prueba"                                 /Commit-->',TO_DATE('12/12/2018'),12,2,3,true);
  ...
  PRUEBAS_CITAS.ACTUALIZAR('Cit-04/update-"Cita=prueba actualizar"                      /Commit-->',cod_cit,TO_DATE('26/12/2018'),12,2,3,true);
