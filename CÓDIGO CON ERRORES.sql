...
*************************************************************************/
    ...
    values (w_cod_cli,email_cli, dni_cli, nombre_cli, telef_cli, movil_cli,FechAlta_cli);
    w_cod_cli := seq_cliente.nextval;
   ...
   values (w_cod_con,nombre_con,direccion_con,telef_con,email_con,NoCitas_con);
   w_cod_con := seq_concesionario.nextval;
   ...
   values(w_cod,fecha_cit,hora_cit,id_cli_cit,id_conces_cit);
   w_cod := seq_citas.nextval;
